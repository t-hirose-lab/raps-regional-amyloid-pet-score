"""
apply_raps.py — Apply the trained 7-ROI RAPS model to new amyloid PET data.
...
def main(input_csv: str, output_csv: str, model_path: str = "model/raps_7roi_final_model.joblib") -> None:
